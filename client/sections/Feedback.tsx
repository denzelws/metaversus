  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[16px] sm:leading-[45px] leading-[39px] text-white">
      ...
      >
        <img
          src="/planet-09.png"
          alt="Shows a group of planets with a rocket in the middle"
